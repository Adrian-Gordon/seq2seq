...
def generate_train_samples(x = train_data_x, batch_size = 4, input_seq_len = input_seq_len, output_seq_len = output_seq_len):
...
with tf.Session() as sess:
  ...
  l2, = plt.plot(range(85, 105), true_signal(test_data_x), 'yo', label = 'Test truth')
